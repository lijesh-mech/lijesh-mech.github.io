...
/* Clickable patent overview image */
.patent-image-link{
  display:block;
  padding:14px;
  background:#f4f6fa;
...
<a
  ...
  aria-label="Open Damage Assessment of Tribo-Systems patent details"
>
  <img
...
<imgsrc="{{ '/assets/img/patents/multi_material_smart_structure.png' | relative_url }}"alt="Large view of the Multi-Material Smart Structure patent overview"
