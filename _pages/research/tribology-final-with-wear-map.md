...
.badge{display:inline-flex;margin-bottom:13px;padding:7px 10px;border:1px solid rgba(255,255,255,.28);border-radius:999px;background:#461d7c;color:#fff;font-size:11px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}
.validation h2{margin:0 0 11px;color:#2a1a55;font-size:25px;font-weight:900;line-height:1.25}.validation>p{margin:0 0 16px;color:#222!important;font-size:16px;line-height:1.78}
.validation ul{display:flex;flex-direction:column;gap:9px;margin:0;padding:0;list-style:none}.validation li{display:grid;grid-template-columns:22px 1fr;gap:10px;color:#222!important;font-size:15px;line-height:1.6}
...
.note{margin-top:15px!important;padding-top:13px;border-top:1px solid #D9C35B;color:#333!important;font-size:13px!important;line-height:1.65;font-style:normal}
...
/* Keep the yellow validation card readable in both light and dark modes */
.validation,
html[data-theme="dark"] .validation,
body.dark .validation,
body.dark-mode .validation{
  color:#222!important;
}

.validation h2,
html[data-theme="dark"] .validation h2,
body.dark .validation h2,
body.dark-mode .validation h2{
  color:#2a1a55!important;
}

.validation > p,
.validation li,
.validation li span:last-child,
html[data-theme="dark"] .validation > p,
html[data-theme="dark"] .validation li,
html[data-theme="dark"] .validation li span:last-child,
body.dark .validation > p,
body.dark .validation li,
body.dark .validation li span:last-child,
body.dark-mode .validation > p,
body.dark-mode .validation li,
body.dark-mode .validation li span:last-child{
  color:#222!important;
}

.validation .note,
html[data-theme="dark"] .validation .note,
body.dark .validation .note,
body.dark-mode .validation .note{
  color:#333!important;
}

.validation .note em,
html[data-theme="dark"] .validation .note em,
body.dark .validation .note em,
body.dark-mode .validation .note em{
  color:#2a1a55!important;
  font-weight:800;
}
...
<div class="trib-page">
  ...
  <div class="opening">
    ...
    <aside class="validation">
      ...
      <h2>Advantages of the DEG-Based Wear Model</h2>
      <p>
