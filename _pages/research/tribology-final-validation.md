...
.validation h2{margin:0 0 11px;color:#2a1a55;font-size:28px;font-weight:900}.validation>p{margin:0 0 14px;color:#222;font-size:15px;line-height:1.75}
.validation ul{display:flex;flex-direction:column;gap:9px;margin:0;padding:0;list-style:none}.validation li{display:grid;grid-template-columns:22px 1fr;gap:9px;color:#222;font-size:15px;line-height:1.6}
...
.note{margin-top:15px!important;padding-top:13px;border-top:1px solid #D9C35B;color:#444!important;font-size:13px!important;line-height:1.6;font-style:normal}
