...
.validation{padding:25px;border:1px solid rgba(255,255,255,.18);border-top:6px solid var(--g);background:linear-gradient(145deg,var(--p),var(--pd));box-shadow:0 10px 28px rgba(50,16,95,.22)}
.badge{display:inline-flex;margin-bottom:13px;padding:7px 10px;border:1px solid rgba(255,255,255,.28);border-radius:999px;background:rgba(255,255,255,.13);color:var(--g);font-size:10px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}
.validation h2{margin:0 0 11px;color:#fff;font-size:23px;font-weight:850}.validation>p{margin:0 0 14px;color:rgba(255,255,255,.92);font-size:13px;line-height:1.65}
.validation ul{display:flex;flex-direction:column;gap:9px;margin:0;padding:0;list-style:none}.validation li{display:grid;grid-template-columns:22px 1fr;gap:9px;color:#fff;font-size:13px;line-height:1.48}
.check{display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;border-radius:50%;background:var(--g);color:var(--pd);font-weight:900}
.note{margin-top:15px!important;padding-top:13px;border-top:1px solid rgba(255,255,255,.24);color:rgba(255,255,255,.84)!important;font-size:11px!important;font-style:normal}
